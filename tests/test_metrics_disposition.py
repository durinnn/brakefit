...
EPISODES = pd.DataFrame(
    [
        ...
        # 청산 완료 · 손실
        dict(
            episode_id="005490:2026-06-01",
            ticker="005490",
            name="포스코",
            opened_at="2026-06-01",
            closed_at="2026-06-11",
            realized_pnl=-20_000,
            max_unrealized_loss=-25_000,
            max_unrealized_loss_pct=-0.08,
            add_buy_count=0,
            holding_days=10,
            is_open=False,
        ),
        ...
        dict(
            ...
            closed_at=None,
            realized_pnl=0,
            max_unrealized_loss=-80_000,
            max_unrealized_loss_pct=-0.06,
            add_buy_count=0,
            holding_days=20,
            is_open=True,
        ),
